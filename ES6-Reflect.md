...
1. [概述](https://github.com/LbhFront-end/About-ES6/blob/master/ES6-Reflect.md#概述)
2. [静态方法](https://github.com/LbhFront-end/About-ES6/blob/master/ES6-Reflect.md#静态方法)
3. [实例：使用 Proxy 实现观察者模式](https://github.com/LbhFront-end/About-ES6/blob/master/ES6-Reflect.md#实例使用-proxy-实现观察者模式)
...
Proxy(target, {
    set: function(target, name, value, receiver){
        var success = Reflect.set(target, name, valuem receiver);
        if(success){
